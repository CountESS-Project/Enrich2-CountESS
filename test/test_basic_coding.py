...
class TestBasicSeqLibCountsIntegrated(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls._cfg['fastq']['reads'] = 'data/reads/basic/all_settings.fq'
...
class TestBasicSeqLibCountsSynonymous(unittest.TestCase):
    ...
    def test_main(self):
        driver = HDF5Verifier()
        driver(self, coding_prefix='c', file_prefix='synonymous', sep=';')
...
class TestBasicSeqLibCountsSingleMutation(unittest.TestCase):
    ...
    def test_main(self):
        driver = HDF5Verifier()
        driver(self, coding_prefix='c', file_prefix='single_mut', sep=';')
...
class TestBasicSeqLibCountsMultiMutation(unittest.TestCase):
    ...
    def test_main(self):
        driver = HDF5Verifier()
        driver(self, coding_prefix='c', file_prefix='multi_mut', sep=';')
...
class TestBasicSeqLibCountsWildType(unittest.TestCase):
    ...
    def test_main(self):
        driver = HDF5Verifier()
        driver(self, coding_prefix='c', file_prefix='wildtype', sep=';')
...
class TestBasicSeqLibCountsWithMaxNFQFilter(unittest.TestCase):
    ...
    def test_main(self):
        driver = HDF5Verifier()
        driver(self, coding_prefix='c', file_prefix='filter_maxn', sep=';')
...
class TestBasicSeqLibCountsWithChaste(unittest.TestCase):
    ...
    def test_main(self):
        driver = HDF5Verifier()
        driver(self, coding_prefix='c', file_prefix='filter_chastity', sep=';')
...
class TestBasicSeqLibCountsWithMinQualFQFilter(unittest.TestCase):
    ...
    def test_main(self):
        driver = HDF5Verifier()
        driver(self, coding_prefix='c', file_prefix='filter_minq', sep=';')
...
class TestBasicSeqLibCountsWithAvgQualFQFilter(unittest.TestCase):
    ...
    def test_main(self):
        driver = HDF5Verifier()
        driver(self, coding_prefix='c', file_prefix='filter_avgq', sep=';')
...
class TestBasicSeqLibCountsTrimLengthSetting(unittest.TestCase):
    ...
    def test_main(self):
        driver = HDF5Verifier()
        driver(self, coding_prefix='c', file_prefix='trim_len', sep=';')
...
class TestBasicSeqLibCountsTrimStartSetting(unittest.TestCase):
    ...
    def test_main(self):
        driver = HDF5Verifier()
        driver(self, coding_prefix='c', file_prefix='trim_start', sep=';')
...
class TestBasicSeqLibCountsReverseSetting(unittest.TestCase):
    ...
    def test_main(self):
        driver = HDF5Verifier()
        driver(self, coding_prefix='c', file_prefix='revcomp', sep=';')
...
class TestBasicSeqLibCountsWithRefOffset(unittest.TestCase):
    ...
    def test_main(self):
        driver = HDF5Verifier()
        driver(self, coding_prefix='c', file_prefix='wtoffset', sep=';')
...
class TestBasicSeqLibCountsWithRefOffsetNotMultipleOfThree(unittest.TestCase):
    ...
    def test_main(self):
        driver = HDF5Verifier()
        driver(self, coding_prefix='c', file_prefix='wtoffset_not_multiple',
               sep=';')
