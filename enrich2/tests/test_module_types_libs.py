...
class BaseLibraryConfigTest(TestCase):
    ...
    def test_override_defaults_correctly(self):
        ...
        self.assertEqual(
            base_cfg.fastq_cfg.reads,
            os.path.join(self.data_dir, 'polyA_t0.fq'))
        ...
        self.assertEqual(
            base_cfg.fastq_cfg.filters_cfg.max_n, 2)
        self.assertEqual(
            base_cfg.fastq_cfg.filters_cfg.avg_base_quality, 10)
        self.assertEqual(
            base_cfg.fastq_cfg.filters_cfg.min_base_quality, 10)
    ...
    def test_correct_seqlib_type(self):
        ...
        barcodeid = json.load(
            open(os.path.join(self.data_dir, 'barcodeid.json'), 'r')
        )
        ...
        barcodevar = json.load(
            open(
                os.path.join(self.data_dir, 'barcodevariant_coding.json'), 'r')
        )
...
class BarcodeSeqLibConfigTest(TestCase):
    ...
    def test_minimal_config_loads_correctly(self):
        ...
        self.assertEqual(cfg.fastq_cfg.filters_cfg.avg_base_quality, 0)
        self.assertEqual(cfg.fastq_cfg.filters_cfg.min_base_quality, 0)
        self.assertEqual(cfg.fastq_cfg.reads,
                         os.path.join(self.data_dir, 'polyA_t0.fq'))
...
class BcidSeqLibConfigTest(TestCase):
    ...
    def setUp(self):
        ...
        self.basic_cfg = {
            FASTQ: self.fastq_cfg,
            BARCODES: {
                BARCODE_MAP_FILE: self.map_path
            },
            IDENTIFIERS: {},
            NAME: 'BcidSeqLib',
            TIMEPOINT: 0,
